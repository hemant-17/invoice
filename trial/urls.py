...
urlpatterns = [
    ...
    #path('login/wallet/',views.WalletListView.as_view()),
   ...
   path('login/settle/',views.Invoice_settleListView.settle,name='settle'),
   #path('login/final_settle/',views.final_settle,name='final_settle'),
